...
const districtCards = {
  ...
  "/commercial-real-estate/CA/sunnyvale/moffett-park/": [
    card("Borregas Avenue R&D building", "1195 Borregas Ave", "R&D / office", "A technology-oriented R&D example in the Moffett Park business grid.", "Useful context for engineering and R&D teams that want a North Sunnyvale business-park setting.", { listing_frequency: 5, keyword_relevance: 5, district_consistency: 5 }),
    card("Borregas Avenue office campus", "1277 Borregas Ave", "Office campus", "A campus-style office example in the heart of Moffett Park.", "This type of property helps define the district for larger technology and engineering users.", { building_prominence: 5, commercial_relevance: 5 }),
    card("Kifer Road flex/R&D building", "1310 Kifer Rd", "Flex / R&D", "A low-rise flex and R&D example along a practical business corridor.", "Shows the flexible technical space options available around Moffett Park without implying current availability.", { keyword_relevance: 5, multiple_listing_references: 4 }),
    ...
    card("Lakeway Drive office building", "710 Lakeway Dr", "Technology office", "Business-park office environment within Moffett Park's campus-oriented geography.", "A useful example of the office format teams may weigh against North Bayshore or Santa Clara.", { building_prominence: 4, keyword_relevance: 4 }),
    ...
    card("Bordeaux Drive campus block", "Bordeaux Dr", "Office campus", "A large-format campus example tied to Moffett Park's technology concentration.", "Best understood as space for larger office and R&D users rather than streetfront firms.", { building_prominence: 5, keyword_relevance: 4 }),
    card("Java Drive business park building", "Java Dr", "Office / R&D", "Business-park property near the northern Sunnyvale employment cluster.", "Shows the campus and R&D blocks that make Moffett Park a regional alternative.", { district_consistency: 5, commercial_relevance: 5 }),
  ...
  "/commercial-real-estate/CA/mountain-view/north-bayshore/": [
    card("Amphitheatre Parkway campus building", "Amphitheatre Pkwy", "Technology campus", "A large technology-campus example near the bayfront employment core.", "Useful for teams evaluating North Bayshore's campus-oriented setting near major Mountain View employers.", { building_prominence: 5, keyword_relevance: 5, district_consistency: 5 }),
    ...
    card("Shoreline office campus", "Shoreline Blvd", "Office campus", "Campus-oriented office building near Shoreline access and bayfront employers.", "A clear example of why North Bayshore often comes up alongside Moffett Park and Stanford Research Park.", { building_prominence: 5, commercial_relevance: 5 }),
    ...
    card("Bayshore Parkway office building", "Bayshore Pkwy", "Office / R&D", "Business-park office property near the bayfront commute network.", "Shows the larger office and R&D format that gives North Bayshore its campus feel.", { keyword_relevance: 4, commercial_relevance: 5 }),
    ...
    card("Alta Avenue flex building", "Alta Ave", "Flex / service commercial", "Smaller flex-commercial building near the district's industrial support edge.", "Adds context for the support businesses that sit around larger campus users.", { keyword_relevance: 4, multiple_listing_references: 3 }),
    card("Charleston business park block", "Charleston Rd", "Office / R&D", "A repeatable office and R&D block in the North Bayshore employment district.", "Shows the practical workspace format behind much of North Bayshore's office and R&D demand.", { district_consistency: 5, commercial_relevance: 5 }),
  ],

  "/commercial-real-estate/CA/redwood-city/downtown-redwood-city/": [
    card("Broadway mixed-use office building", "Broadway", "Downtown office / retail", "A walkable downtown office and retail example near Redwood City's commercial core.", "Typical of the smaller mixed-use buildings that support professional services and local office users.", { listing_frequency: 4, keyword_relevance: 4, district_consistency: 5 }, { keyword_tags: ["office", "retail", "downtown"] }),
    card("2065 Broadway Street", "2065 Broadway St", "Retail / service commercial", "Street-level commercial building on a defining downtown Redwood City corridor.", "Helps show the active ground-floor setting that differentiates Downtown Redwood City from office-park alternatives.", { district_consistency: 5, commercial_relevance: 4 }, { canonical_path: "/commercial-real-estate/building/CA/redwood-city/2065-broadway-st/", keyword_tags: ["retail", "service", "Broadway"] }),
    card("2400 Broadway", "2400 Broadway", "Retail / mixed-use", "Broadway corridor building with a clear downtown commercial setting.", "Adds a real downtown address to anchor the district's mixed-use commercial character.", { listing_frequency: 4, multiple_listing_references: 4, district_consistency: 5 }, { canonical_path: "/commercial-real-estate/building/CA/redwood-city/2400-broadway/", keyword_tags: ["retail", "mixed-use", "downtown"] }),
    card("El Camino Real commercial edge", "El Camino Real", "Service commercial / office", "Commercial-edge example where downtown Redwood City meets regional arterial access.", "Shows how a tenant can balance walkable downtown identity with broader Peninsula access.", { keyword_relevance: 4, commercial_relevance: 4 }, { keyword_tags: ["service", "office", "El Camino"] }),
    card("2504 El Camino Real", "2504 El Camino Real", "Retail / service commercial", "El Camino Real commercial building serving local services and customer-facing businesses.", "A useful example of the service-commercial edge of the downtown market.", { district_consistency: 4, commercial_relevance: 4 }, { canonical_path: "/commercial-real-estate/building/CA/redwood-city/2504-el-camino-real/", keyword_tags: ["retail", "service", "arterial"] }),
    card("Twin Dolphin Drive office building", "303 Twin Dolphin Dr", "Office building", "Office property near Redwood City's lagoon and Highway 101 office context.", "A larger office example that helps frame the choice between downtown Redwood City and nearby 101-oriented settings.", { listing_frequency: 5, multiple_listing_references: 5, commercial_relevance: 5 }, { canonical_path: "/commercial-real-estate/building/CA/redwood-city/303-twin-dolphin-drive/", keyword_tags: ["office", "Peninsula", "101 access"] }),
    card("Seaport Boulevard office building", "1400 Seaport Blvd", "Office / waterfront business park", "Larger office example near Redwood City's waterfront and life-science-adjacent business environment.", "Adds larger-format office context without making the downtown page read like only streetfront retail.", { building_prominence: 4, commercial_relevance: 4 }, { canonical_path: "/commercial-real-estate/building/CA/redwood-city/1400-seaport-blvd-bldg-9/", keyword_tags: ["office", "waterfront", "business park"] }),
    ...
    card("Winslow Street commercial building", "Winslow St", "Office / service commercial", "Secondary-street commercial example near the downtown core.", "Shows the quieter office and local service locations a tenant may evaluate near Broadway.", { district_consistency: 4, commercial_relevance: 4 }, { keyword_tags: ["office", "service", "downtown"] }),
    card("Middlefield Road commercial building", "Middlefield Rd", "Service commercial / office", "Commercial example connecting downtown Redwood City with surrounding Peninsula neighborhoods.", "Adds local-service and small-office context to the district's downtown identity.", { keyword_relevance: 4, district_consistency: 4 }, { keyword_tags: ["service", "office", "local business"] }),
  ],

  "/commercial-real-estate/CA/emeryville/emeryville-commercial-core/": [
    card("1900 Powell Street", "1900 Powell St", "Office building", "Multi-tenant office building in Emeryville's Powell Street business corridor.", "A concrete example of the established office buildings that shape Emeryville's central business area.", { listing_frequency: 5, multiple_listing_references: 5, district_consistency: 5 }, { canonical_path: "/commercial-real-estate/building/CA/emeryville/1900-powell-st/", keyword_tags: ["office", "Powell", "East Bay"] }),
    card("Christie Avenue office building", "Christie Ave", "Office / life science support", "An example of Emeryville's office and life-science support buildings near Bay Street and Powell Street.", "This area can work well for teams that want East Bay access with a more business-park feel than downtown Berkeley or Oakland.", { listing_frequency: 4, keyword_relevance: 4, district_consistency: 5 }, { keyword_tags: ["office", "life science", "Christie"] }),
    card("5760 Christie Avenue", "5760 Christie Ave", "Office / mixed commercial", "A Christie Avenue commercial example in Emeryville's central office and service-business area.", "Shows the practical office and service-commercial environment near the Bay Bridge side of the East Bay.", { listing_frequency: 4, district_consistency: 5, commercial_relevance: 4 }, { keyword_tags: ["office", "mixed commercial", "Christie"] }),
    card("Powell Street business corridor", "Powell St", "Office / R&D support", "A Powell Street corridor example for office, R&D support, and professional-service users.", "This part of Emeryville offers quick access to Berkeley, Oakland, and the Bay Bridge while keeping a practical business-district feel.", { keyword_relevance: 5, commercial_relevance: 5 }, { keyword_tags: ["office", "R&D", "Powell"] }),
    card("1603 Powell Street", "1603 Powell St", "Office / service commercial", "A smaller Powell Street commercial example near the district's core.", "Adds a smaller Emeryville option alongside the district's larger office references.", { district_consistency: 5, commercial_relevance: 4 }, { keyword_tags: ["office", "service", "Powell"] }),
    card("Horton Street industrial office", "Horton St", "Industrial / creative office", "Industrial-edge space tied to Emeryville's production, creative, and research-adjacent uses.", "Shows the adaptive and industrial-commercial layer that differentiates Emeryville from a conventional downtown.", { keyword_relevance: 5, commercial_relevance: 5 }, { keyword_tags: ["industrial", "creative", "R&D"] }),
    card("Shellmound Street commercial building", "Shellmound St", "Office / retail support", "Commercial example near Emeryville's retail and office spine.", "Adds context for the mixed-use environment around the city's office and biotech-adjacent users.", { district_consistency: 4, commercial_relevance: 4 }, { keyword_tags: ["office", "retail", "Shellmound"] }),
    ...
    card("Landregan Street flex building", "Landregan St", "Flex / light industrial", "Smaller flex-commercial example in Emeryville's industrial-transition area.", "Shows the practical production-adjacent space that supports creative, maker, and R&D users.", { keyword_relevance: 5, district_consistency: 4 }, { keyword_tags: ["flex", "light industrial", "maker"] }),
    card("Adeline Street commercial edge", "Adeline St", "Service commercial / office", "Commercial-edge example connecting Emeryville with Berkeley and Oakland corridors.", "Useful for understanding corridor-based locations near the Emeryville and Berkeley edge.", { district_consistency: 4, commercial_relevance: 4 }, { keyword_tags: ["service", "office", "Berkeley edge"] }),
  ],

  "/commercial-real-estate/CA/berkeley/downtown-berkeley/": [
    card("2001 Addison Street", "2001 Addison St", "Office building", "University-adjacent office building in Downtown Berkeley's civic and transit-oriented core.", "A concrete downtown example for teams that want BART, UC Berkeley, and civic-area access.", { listing_frequency: 5, multiple_listing_references: 5, district_consistency: 5 }, { canonical_path: "/commercial-real-estate/building/CA/berkeley/2001-addison-st/", keyword_tags: ["office", "BART", "university"] }),
    card("2120 University Avenue", "2120 University Ave", "Professional office", "Office building near Downtown Berkeley's University Avenue commercial corridor.", "A good example for professional and service-office users that want university and BART access.", { listing_frequency: 3, district_consistency: 5, commercial_relevance: 4 }, { canonical_path: "/commercial-real-estate/building/CA/berkeley/2120-university-ave/", keyword_tags: ["office", "University Ave", "professional"] }),
    card("Shattuck Avenue office building", "Shattuck Ave", "Office / service commercial", "Transit-oriented office and service-commercial example in the downtown core.", "Shows the customer-facing and professional-services layer around Downtown Berkeley BART.", { keyword_relevance: 4, commercial_relevance: 5 }, { keyword_tags: ["office", "BART", "service"] }),
    card("Center Street civic office", "Center St", "Civic / professional office", "Downtown office example near Berkeley's civic, arts, and institutional activity.", "Useful for organizations that value Berkeley identity and walkable downtown access.", { district_consistency: 5, commercial_relevance: 4 }, { keyword_tags: ["civic", "office", "walkable"] }),
    card("Allston Way professional building", "Allston Way", "Professional office", "Smaller professional-office example close to BART and UC Berkeley.", "Adds small-team and professional-services context beyond larger downtown buildings.", { keyword_relevance: 4, district_consistency: 4 }, { keyword_tags: ["professional", "office", "small team"] }),
    card("Oxford Street institutional edge", "Oxford St", "Institutional / office", "Office and institutional-adjacent commercial example near the UC Berkeley edge.", "Useful for university-facing organizations that want Downtown Berkeley instead of a more business-park setting.", { building_prominence: 4, commercial_relevance: 5 }, { keyword_tags: ["institutional", "university", "office"] }),
    card("Milvia Street service office", "Milvia St", "Service office", "Local service and office example near Berkeley's downtown civic core.", "A practical fit for smaller office users serving Berkeley clients and institutions.", { district_consistency: 4, commercial_relevance: 4 }, { keyword_tags: ["service", "office", "local business"] }),
    card("Kittredge Street commercial building", "Kittredge St", "Office / retail support", "Secondary downtown commercial example near the main office and transit spine.", "Adds the smaller mixed commercial texture that keeps Downtown Berkeley distinct from campus-only locations.", { keyword_relevance: 4, district_consistency: 4 }, { keyword_tags: ["office", "retail", "downtown"] }),
  ],

  "/commercial-real-estate/CA/berkeley/west-berkeley/": [
    card("Fourth Street maker/flex building", "Fourth St", "Maker / flex", "An adaptive commercial example near West Berkeley's showroom, maker, and light-industrial edge.", "Typical of businesses that need production-adjacent space rather than a formal downtown office setting.", { keyword_relevance: 5, district_consistency: 5, commercial_relevance: 5 }, { keyword_tags: ["maker", "flex", "showroom"] }),
    card("Gilman Street industrial building", "Gilman St", "Industrial / flex", "Industrial and flex example along a defining West Berkeley corridor.", "Shows the service, production, and R&D-adjacent properties that often make West Berkeley different from Emeryville.", { keyword_relevance: 5, commercial_relevance: 5 }, { keyword_tags: ["industrial", "flex", "production"] }),
    card("Heinz Avenue R&D building", "Heinz Ave", "R&D / light industrial", "R&D and light-industrial example in Berkeley's west-side commercial district.", "A practical fit for companies needing technical space near Berkeley talent and East Bay access.", { keyword_relevance: 5, district_consistency: 5 }, { keyword_tags: ["R&D", "light industrial", "Berkeley"] }),
    card("Eighth Street flex building", "8th St", "Flex / service commercial", "Smaller flex-commercial example near West Berkeley's industrial grid.", "Adds practical service-business and production space beyond office-only examples.", { keyword_relevance: 4, commercial_relevance: 4 }, { keyword_tags: ["flex", "service", "production"] }),
    ...
    card("San Pablo Avenue commercial edge", "San Pablo Ave", "Service commercial / showroom", "Commercial corridor example connecting West Berkeley to Emeryville and Oakland.", "Good context for showroom, service, and customer-facing uses on the district's eastern edge.", { district_consistency: 4, commercial_relevance: 4 }, { keyword_tags: ["showroom", "service", "corridor"] }),
    card("Ashby Avenue industrial edge", "Ashby Ave", "Flex / light industrial", "Industrial-edge example with regional access across Berkeley and Emeryville.", "Shows the access-oriented side of West Berkeley's commercial geography.", { keyword_relevance: 4, commercial_relevance: 4 }, { keyword_tags: ["flex", "access", "industrial"] }),
    card("University Avenue west-side commercial", "University Ave", "Office / service commercial", "West-side commercial example connecting Berkeley's downtown and waterfront-oriented districts.", "Adds a bridge between university-adjacent office demand and West Berkeley's flex environment.", { district_consistency: 4, commercial_relevance: 4 }, { keyword_tags: ["office", "service", "university"] }),
    card("Potter Street production building", "Potter St", "Production / flex", "Production-oriented flex example in the industrial-transition area.", "Useful for maker and operations users that need West Berkeley rather than a formal office core.", { keyword_relevance: 5, district_consistency: 4 }, { keyword_tags: ["production", "flex", "operations"] }),
    card("West Berkeley warehouse conversion", "West Berkeley", "Adaptive warehouse / creative office", "Warehouse-conversion example supporting creative office, studio, and R&D-adjacent businesses.", "Helps describe the district's hybrid identity without implying current availability at a specific listing.", { building_prominence: 3, keyword_relevance: 5, commercial_relevance: 5 }, { keyword_tags: ["adaptive reuse", "warehouse", "creative office"] }),
  ],
