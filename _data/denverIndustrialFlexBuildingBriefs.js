...
const records = [
  ...
  record({
    ...
    editorialRole: "Warehouse / Industrial Depth",
    editorialReason: "Represents a Northeast Denver warehouse environment where storage, receiving, shipping, and I-70 access shape fit.",
    representativeThemes: ["Warehouse", "Distribution", "Storage", "I-70 access"],
    businessFit: ["warehouse", "distribution", "storage", "service distribution"],
    relatedDistrictPaths: [districts.airportPena.path],
    nearbyBuildingPaths: [
    ...
    brief: {
      summary: "10500-10600 E. 54th Ave is a Northeast Denver Industrial Building Profile for businesses comparing warehouse, storage, receiving, shipping, and distribution fit near I-70. It helps occupiers understand the warehouse side of the district without assuming current availability, loading configuration, clear height, or suite-level readiness.",
      rofoTake: "This profile matters because Northeast Denver Industrial needs a warehouse-depth example between the largest distribution benchmarks and smaller service-industrial buildings. 10500-10600 E. 54th Ave helps Rofo explain how storage, goods movement, loading validation, and Denver-side industrial access shape a practical warehouse search.",
      snapshot: [
        { label: "Primary ecosystem", value: "Industrial & flex" },
        { label: "Business use", value: "Warehouse and distribution comparison" },
        { label: "District", value: "Northeast Denver Industrial" },
        { label: "Access context", value: "Denver-side I-70 industrial corridor with airport and regional movement context" },
        { label: "Evidence role", value: "Warehouse / industrial depth" },
        { label: "Validation context", value: "Loading, truck circulation, clear height, parking, and current suite configuration require verification" },
      ],
      bestFit: [
        "Warehouse, distribution, wholesaling, storage, and service-distribution users comparing Denver-side I-70 industrial access.",
        "Operations teams that need to evaluate receiving, shipping, inventory flow, parking, and truck movement before shortlisting space.",
        "Businesses comparing Northeast Denver Industrial against Commerce City, Aurora, or the Denver Airport / Pena corridor for warehouse fit.",
      ],
      mayNotFit: [
        "Small contractors that mainly need compact service space, dispatch, or equipment storage rather than a warehouse-oriented environment.",
        "Customer-facing office, showroom, or retail users that need stronger visibility, walkability, or visitor experience.",
        "Production users whose power, ventilation, code, or permitted-use requirements cannot be validated from district context alone.",
      ],
      buildingExperience: "The useful question is whether the property can support the way inventory, employees, trucks, and deliveries move through the business. A tour should validate loading, circulation, parking, office percentage, storage layout, and how well the available suite matches actual operating volume.",
      locationContext: "10500-10600 E. 54th Ave sits in Northeast Denver Industrial, a Denver-side industrial corridor where I-70 access, airport reach, warehouse formats, and service-industrial utility shape fit. Compare larger warehouse examples such as 10445 E 49th Ave, production-oriented examples such as 11551 E 49th Ave, and the Airport / Pena corridor when airport-specific logistics matter more.",
      advantages: [
        "Adds warehouse-specific depth to Northeast Denver Industrial's Building Profile coverage.",
        "Helps users distinguish storage and distribution needs from small-bay service or production-oriented requirements.",
        "Supports comparison between Denver-side I-70 industrial geography and airport/Pena or Commerce City alternatives.",
      ],
      tradeoffs: [
        "Warehouse-oriented environments may be less useful for customer-facing, office-heavy, or showroom users.",
        "The right fit depends on suite-specific loading, clear height, column spacing, parking, and truck circulation.",
        "Current availability, suite condition, landlord approvals, and operational permissions must be verified directly.",
      ],
      operationalProfile: [
        { label: "Warehouse function", summary: "Use this profile to compare storage, receiving, shipping, inventory flow, and whether the suite format matches the business's daily warehouse rhythm." },
        { label: "Truck and loading validation", summary: "Validate dock or grade-level access, delivery routes, truck circulation, parking, and any trailer or staging needs before shortlisting." },
        { label: "Northeast Denver access", summary: "The district supports Denver-side I-70 and airport-oriented industrial movement, but the right fit still depends on supplier, employee, customer, and delivery geography." },
      ],
      environmentExplanation: {
        whyItExists: "Warehouse and distribution environments exist for businesses that need storage and goods movement to work with access, loading, labor, and building configuration.",
        whyChooseThisEnvironment: "Choose this environment over smaller service-industrial space when inventory movement and warehouse function matter more than compact dispatch utility. Choose it over office/flex when the requirement is operational rather than workplace-oriented.",
        representativeValue: "10500-10600 E. 54th Ave adds a warehouse-depth benchmark to Northeast Denver Industrial.",
      },
      nearbyAlternatives: [
        { label: "10445 E 49th Ave", url: buildingPath("10445 E 49th Ave"), reason: "Compare when larger-format warehouse or distribution scale is the stronger operating question." },
        { label: "11551 E 49th Ave", url: buildingPath("11551 E 49th Ave"), reason: "Compare when production-oriented or light-manufacturing requirements may matter more than storage and distribution." },
        { label: "10515-10525 E 40th Ave", url: buildingPath("10515-10525 E 40th Ave"), reason: "Compare when smaller service-industrial or contractor utility may fit better than warehouse depth." },
      ],
      nearbyDistricts: [
        { label: "Denver Airport / Pena Boulevard Corridor", url: districts.airportPena.path, reason: "Compare when airport-specific logistics and east-metro movement matter more than central Northeast Denver access." },
      ],
      relatedDistricts: [
        { districtId: "den-airport-pena-corridor", reason: "Compare for airport-specific logistics and east-metro reach." },
      ],
      validationNotes: [
        "Confirm current suite size, loading configuration, door access, and truck circulation.",
        "Verify clear height, column spacing, sprinkler assumptions, storage layout, and any racking requirements.",
        "Confirm parking allocation, delivery hours, trailer staging, and site-access rules.",
        "Validate permitted use, office percentage, power, ventilation, and any specialized operating requirements.",
      ],
      representativeCompanies: [
        "Relevant company categories include distributors, wholesalers, storage users, e-commerce fulfillment users, and service-distribution businesses.",
        "These categories describe operating-model fit and do not identify current tenants.",
      ],
      ecosystemSubtypes: ["warehouse", "distribution", "last_mile_logistics"],
      representativeRole: "warehouse_industrial_depth",
      businessActivities: ["receiving", "shipping", "distribution", "inventory_management", "storage"],
      businessArchetypes: ["distributor", "wholesaler", "ecommerce_fulfillment_business", "service_distribution_business"],
      operationalCharacteristics: ["warehouse_function", "regional_distribution_access", "freeway_access", "delivery_access", "industrial_identity"],
      fitSummary: "Warehouse fit depends on storage layout, loading validation, truck access, and regional movement.",
      sourceNotes: ["Repository Knowledge Graph identifies 10500-10600 E. 54th Ave as a Northeast Denver Industrial representative building for warehouse, distribution, receiving, shipping, and storage use cases."],
    },
  }),
  record({
  ...
  record({
    ...
    districtKey: "northeast",
    buildingType: "Light manufacturing / industrial",
    primarySpaceType: "industrial",
    editorialRole: "Light Manufacturing Environment",
    editorialReason: "Represents production-oriented industrial evaluation in Northeast Denver, where assembly, light manufacturing, receiving, shipping, and property-level validation shape fit.",
    representativeThemes: ["Light manufacturing", "Production support", "Industrial service", "I-70 access"],
    businessFit: ["light manufacturing", "assembly", "production support", "industrial service"],
    relatedDistrictPaths: [districts.airportPena.path],
    nearbyBuildingPaths: [
      buildingPath("10500-10600 E. 54th Ave"),
      buildingPath("10445 E 49th Ave"),
    ...
    brief: {
      summary: "11551 E 49th Ave is a Northeast Denver Industrial Building Profile for businesses comparing light manufacturing, assembly, production-support, receiving, and shipping environments. It helps teams evaluate production-oriented industrial fit while keeping power, ventilation, loading, code, and permitted-use validation explicit.",
      rofoTake: "This profile matters because Northeast Denver Industrial should not be explained only through warehouse and distribution examples. 11551 E 49th Ave gives Rofo a production-oriented benchmark for users whose decision depends on industrial utility, building systems, loading, and operating permissions rather than customer-facing image.",
      snapshot: [
        { label: "Primary ecosystem", value: "Industrial & flex" },
        { label: "Business use", value: "Light manufacturing and production-support comparison" },
        { label: "District", value: "Northeast Denver Industrial" },
        { label: "Access context", value: "Denver-side I-70 industrial corridor with warehouse, service, and production context" },
        { label: "Evidence role", value: "Light manufacturing environment" },
        { label: "Validation context", value: "Power, ventilation, loading, permitted use, clear height, and current suite condition require verification" },
      ],
      bestFit: [
        "Light manufacturers, assembly users, fabrication-adjacent businesses, and production-support companies comparing Northeast Denver industrial utility.",
        "Industrial users that need receiving, shipping, storage, and production workflow validation before comparing heavier industrial alternatives.",
        "Businesses deciding whether Northeast Denver provides enough operational fit or whether Commerce City or another industrial corridor should be evaluated.",
      ],
      mayNotFit: [
        "Pure warehouse or distribution users that mainly need storage density, loading throughput, and trailer movement.",
        "Office, showroom, or customer-facing users that need stronger visitor experience, visibility, or polished workplace identity.",
        "Specialized production users whose process requires property-specific power, ventilation, environmental, hazardous-material, or code validation.",
      ],
      buildingExperience: "The building should be evaluated as a production-support environment, not as a generic industrial address. A useful tour should confirm how materials enter, how work flows through the suite, what utilities are available, and whether the landlord and code framework support the intended use.",
      locationContext: "11551 E 49th Ave sits in Northeast Denver Industrial, where warehouse, service-industrial, and production-support users compare Denver-side I-70 access, airport reach, labor geography, and property-level industrial utility. Compare 10500-10600 E. 54th Ave for warehouse depth and Commerce City when heavier industrial context is central.",
      advantages: [
        "Adds production-oriented industrial evidence to Northeast Denver Industrial.",
        "Helps distinguish light manufacturing requirements from warehouse, distribution, and small-bay service needs.",
        "Gives users a clearer validation path for power, loading, code, and permitted-use questions.",
      ],
      tradeoffs: [
        "Light manufacturing fit cannot be inferred from district identity or address alone.",
        "Power, ventilation, loading, hazardous-material rules, code, and landlord approval require direct validation.",
        "The environment may be less appropriate for customer-facing, office-heavy, or retail/service users.",
      ],
      operationalProfile: [
        { label: "Production workflow", summary: "Use this profile to test whether assembly, fabrication-adjacent activity, storage, receiving, and shipping can work in the same available suite." },
        { label: "Building systems", summary: "Manufacturing-oriented users should validate power, ventilation, loading, clear height, code constraints, and any process-specific requirements before shortlisting." },
        { label: "Industrial corridor fit", summary: "Northeast Denver can support production-support comparison, but heavier or outdoor-storage needs may require Commerce City or another industrial alternative." },
      ],
      environmentExplanation: {
        whyItExists: "Light manufacturing environments exist for businesses that need some production capability plus industrial access, receiving, shipping, storage, and building-system validation.",
        whyChooseThisEnvironment: "Choose this environment over warehouse-only space when production workflow and building systems matter. Choose it over office/flex when operational utility matters more than workplace presentation.",
        representativeValue: "11551 E 49th Ave gives Northeast Denver Industrial a production-oriented benchmark.",
      },
      nearbyAlternatives: [
        { label: "10500-10600 E. 54th Ave", url: buildingPath("10500-10600 E. 54th Ave"), reason: "Compare when warehouse, storage, and distribution fit matter more than production-oriented validation." },
        { label: "10515-10525 E 40th Ave", url: buildingPath("10515-10525 E 40th Ave"), reason: "Compare when smaller service-industrial or contractor operations may be more appropriate." },
        { label: "10445 E 49th Ave", url: buildingPath("10445 E 49th Ave"), reason: "Compare when larger industrial scale and goods movement matter more than light manufacturing fit." },
      ],
      nearbyDistricts: [
        { label: "Denver Airport / Pena Boulevard Corridor", url: districts.airportPena.path, reason: "Compare when airport-specific logistics and east-metro movement are stronger requirements." },
      ],
      relatedDistricts: [
        { districtId: "den-airport-pena-corridor", reason: "Compare for airport-specific logistics and east-metro reach." },
      ],
      validationNotes: [
        "Confirm permitted use, zoning fit, landlord approval, and code requirements for the intended production activity.",
        "Verify power, ventilation, loading, clear height, storage layout, and any process-specific improvements.",
        "Confirm truck access, parking, delivery timing, employee circulation, and material handling.",
        "Validate hazardous-material restrictions, waste handling, insurance requirements, and any compliance needs before committing.",
      ],
      representativeCompanies: [
        "Relevant company categories include light manufacturers, production-support businesses, specialty fabricators, cabinet shops, furniture makers, and industrial service companies.",
        "These categories describe operating-model fit and do not identify current tenants.",
      ],
      ecosystemSubtypes: ["light_manufacturing", "manufacturing", "industrial_service"],
      representativeRole: "light_manufacturing_environment",
      businessActivities: ["assembly", "light_manufacturing", "receiving", "shipping", "storage"],
      businessArchetypes: ["light_manufacturer", "cabinet_shop", "furniture_maker", "specialty_fabricator", "industrial_service_company"],
      operationalCharacteristics: ["production_support", "industrial_identity", "freeway_access", "loading_validation", "building_systems_validation"],
      fitSummary: "Light manufacturing fit depends on permitted use, building systems, loading, code, and production workflow validation.",
      sourceNotes: ["Repository Knowledge Graph identifies 11551 E 49th Ave as a Northeast Denver Industrial representative building for light manufacturing, assembly, receiving, shipping, and production-support use cases."],
    },
  }),
  record({
