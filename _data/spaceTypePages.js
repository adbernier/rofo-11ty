...
const commercialDistrictIntelligenceBatchV1 = require("./commercialDistrictIntelligenceBatchV1.js");
    ...
    .map((spaceType) => {
      ...
      const localDecisionGuide =
        normalizedCitySlug === "san-francisco" && normalizedStateAbbr === "ca"
          ...
          : normalizedCitySlug === "phoenix" && normalizedStateAbbr === "az" && normalizedTypeSlug === "industrial-space"
          ? phoenixIndustrialPublicDecision
          : null;
      ...
      return {
        ...
        publicCommercialGeography:
          normalizedCitySlug === "san-francisco" && normalizedStateAbbr === "ca"
            ...
            : commercialDistrictIntelligenceBatchV1.byMarketKey[`${stateAbbr}/${normalizedCitySlug}`]?.bySpaceType[normalizedTypeSlug.replace("-space", "")] || null,
      };
    })
