...
function building({
  ...
  return {
    ...
    image_urls: [],
    hero_image: "",
    meta_title: `${address} | Representative ${district.name} Commercial Building | Rofo`,
    meta_description: `See why businesses may compare ${address} in ${district.name}. Understand fit, tradeoffs, nearby alternatives, and what to validate before adding similar buildings to a shortlist.`,
