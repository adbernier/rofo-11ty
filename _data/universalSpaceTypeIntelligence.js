...
const office = foundation("office", "Office", "office", [
  ...
  dimension("office.workplace_environment", "Workplace environment", "Building character and neighborhood setting affect employee experience and business image.", [signal("dimension", "office.environment.image"), signal("dimension", "office.workplace.meetings_collaboration"), signal("dimension", "universal.business.type")], ["building quality and character", "employee environment", "workplace setting"], "No building or neighborhood quality is inferred without reviewed evidence."),
  dimension("office.configuration", "Space configuration", "Headcount, collaboration, meetings and flexibility determine whether a space can support the work.", [signal("dimension", "office.occupancy.peak_attendance"), signal("dimension", "office.workplace.meetings_collaboration"), signal("dimension", "universal.growth.future_state"), signal("activity", "meet_collaborate"), signal("dimension", "universal.capacity.size")], ["workspace configuration", "collaborative and focused-work balance", "meeting needs", "growth and flexibility"], "Room counts, floorplates and building capability require property investigation."),
], ["meeting-room needs", "floorplate preference"]);
...
const retail = foundation("retail", "Retail / Service", "retail_service", [
  ...
  dimension("retail.visibility_storefront", "Visibility and storefront", "Frontage, signage, entry and street presence can materially affect customer discovery.", [signal("dimension", "retail.customer.destination_visibility"), signal("dimension", "retail.property.storefront_priority")], ["frontage and visibility", "signage rights", "customer entry", "storefront character"], "No visibility or foot-traffic conclusion is made without property and local evidence."),
  dimension("retail.customer_access", "Customer and service access", "Customer parking, transit, pedestrian arrival and deliveries may pull in different directions.", [signal("dimension", "universal.access.parking_importance"), signal("dimension", "universal.access.transit_importance"), signal("dimension", "retail.operations.delivery_receiving")], ["customer access", "parking and transit", "delivery frequency and service access"], "Actual access conditions require local and property verification."),
...
], ["customer-entry configuration", "adjacency priority", "direct customer-parking need", "food ventilation and utility detail"]);
...
const industrial = foundation("industrial", "Industrial / Warehouse", "industrial_flex", [
  ...
  dimension("industrial.building_function", "Building functionality", "Loading, volume, floor characteristics and warehouse-to-office mix drive operational fit.", [signal("activity", "store"), signal("activity", "receive"), signal("activity", "ship_distribute"), signal("dimension", "industrial.loading.form"), signal("dimension", "industrial.loading.grade_level"), signal("dimension", "industrial.operations.warehouse_storage"), signal("dimension", "industrial.property.office_component")], ["required loading form", "clear height and column spacing", "floor capability", "warehouse-to-office ratio"], "Specifications must be verified for each property."),
  ...
  dimension("industrial.infrastructure", "Infrastructure", "Power, ventilation, refrigeration and utilities may determine whether production can operate.", [signal("activity", "make_assemble"), signal("activity", "prepare_produce_food"), signal("dimension", "industrial.power.three_phase"), signal("dimension", "industrial.power.exact_capacity"), signal("dimension", "food.diligence.infrastructure")], ["power", "specialized utilities", "ventilation", "cold storage"], "Capacity, code and systems require authoritative verification."),
  dimension("industrial.use_compatibility", "Use compatibility", "Operational intensity must be compatible with the building, code and permitted use.", [signal("activity", "repair_service"), signal("activity", "make_assemble"), signal("activity", "prepare_produce_food"), signal("dimension", "universal.diligence.permitted_use"), signal("dimension", "industrial.operations.repair_production")], ["permitted use", "code and building capability", "surrounding use compatibility"], "Rofo does not make zoning or permitted-use conclusions from universal intelligence."),
], ["clear height", "column spacing", "floor loading", "yard/trailer detail", "exact power and utility requirements"]);
...
const flex = foundation("flex", "Flex", "industrial_flex", [
  ...
  dimension("flex.use_mix", "Use mix", "The balance among office, production, showroom, research and storage defines the hybrid requirement.", [signal("dimension", "industrial.operations.use_mix"), signal("activity", "work"), signal("activity", "display_present"), signal("activity", "make_assemble"), signal("activity", "research_test")], ["office-production balance", "showroom or warehouse mix", "technical and maker activity"], "The operating mix describes requirements, not local suitability."),
  ...
  dimension("flex.customer_environment", "Customer-facing environment", "Showroom and collaborative uses may require a different setting from operational warehouse uses.", [signal("dimension", "industrial.customer.visit_priority"), signal("activity", "display_present"), signal("activity", "host_visitors"), signal("dimension", "office.environment.image")], ["showroom or customer-experience quality", "creative or technical context", "customer-facing character"], "No neighborhood or building character is inferred universally."),
], ["adaptability preference", "loading and power detail by mixed use"]);
