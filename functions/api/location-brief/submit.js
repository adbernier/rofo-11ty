...
function buildLocationBriefLead(brief, request, briefUrl) {
  ...
  return {
    ...
    acquisition: brief.acquisition || null,
    originating_journey_id: brief.acquisition?.journeyId || "",
    originating_brief_id: brief.id,
    ...
    location_profile_features: cleanArray(businessProfile.features, 12).join(", "),
    location_profile_feature_other: businessProfile.featureOther || businessProfile.feature_other || "",
    ...
    requirement_known_constraints: investigationRequirements.knownConstraints || "",
