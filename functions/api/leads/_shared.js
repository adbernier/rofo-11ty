...
export function buildLeadPayload(formFields, request) {
  ...
  return {
    ...
    location_brief_v2_public_id: normalizeField(formFields.location_brief_v2_public_id),
    location_brief_v2_url: normalizeField(formFields.location_brief_v2_url),
    location_brief_v2_entry_source: normalizeField(formFields.location_brief_v2_entry_source),
    location_brief_v2_entry_source_path: normalizeField(formFields.location_brief_v2_entry_source_path),
    location_brief_v2_business_archetype: normalizeField(formFields.location_brief_v2_business_archetype),
    timestamp: now,
    status: "pending",
