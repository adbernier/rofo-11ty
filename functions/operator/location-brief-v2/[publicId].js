...
export function renderLocationBriefV2Page(bundle, owner, debug, options = {}) {
  ...
  const guidanceHeading = readiness === "INVESTIGATE" ? "What matters most" : northOrangeCounty || phoenix ? currentSnapshot.productResponse?.heading || "Peer locations worth investigating" : hasCandidates ? "Also worth investigating" : "Locations worth investigating";
