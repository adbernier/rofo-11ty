...
function nextStep(readiness, propertyContinuationSupported) {
  if (!propertyContinuationSupported) return { heading: "Ask Rofo to research spaces for this search", action: "Research Spaces for My Business →", copy: "Share this Location Brief with Rofo so the team can investigate current and upcoming options, property fit, and local alternatives without asking you to repeat the Business Profile." };
