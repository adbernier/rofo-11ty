...
export async function controlledEntryDecision(env, url) {
  ...
  return { eligible, reasonCode: eligible ? (marketId === "san-francisco" ? "SF_COHORT" : marketId === "san-diego" && type === "industrial_flex" ? "SAN_DIEGO_INDUSTRIAL_FLEX_COHORT" : marketId ? "UNIVERSAL_COHORT" : "CONTROLLED_GLOBAL") : marketId && type ? "SEARCH_NOT_ENABLED" : "INCOMPLETE_GLOBAL_COHORT" };
}
