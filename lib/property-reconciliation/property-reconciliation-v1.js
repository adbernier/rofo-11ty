...
const MUNICIPALITY_REVIEW_CLASSIFICATIONS = Object.freeze([
  "CONFIRMED_CURRENT_MUNICIPALITY",
  "LEGACY_SOURCE_WRONG",
  "ADDRESS_AMBIGUOUS",
  "COORDINATE_CONFLICT",
  "MARKET_LABEL_TOO_BROAD",
  "REQUIRES_HUMAN_REVIEW",
]);

const GEOGRAPHY_LINK_REVIEW_CLASSIFICATIONS = Object.freeze([
  "REVIEWED_CONFIRMED",
...
const REPRESENTATIVE_REVIEW_CLASSIFICATIONS = Object.freeze([
  "STRONG_REPRESENTATIVE_CANDIDATE",
  "POSSIBLE_REPRESENTATIVE",
  "NOT_REPRESENTATIVE",
]);

const PUBLIC_REVIEW_CLASSIFICATIONS = Object.freeze([
  "PUBLIC_CANDIDATE_REVIEWED",
  "INTERNAL_ONLY",
  "NEEDS_MORE_EVIDENCE",
  "REJECT_PUBLIC",
]);
...
const STREET_SUFFIXES = Object.freeze({
  ...
  plaza: "plz", street: "st", terrace: "ter", trail: "trl", way: "way",
});
...
function reconcileGroup(input) {
  ...
  return {
    ...
    municipalityReview: input.municipalityReview || null,
    geographyLinkReview: input.geographyLinkReview || null,
    deepReview: input.deepReview || null,
    representativePotential: input.representativePotential || "NOT_REPRESENTATIVE",
    representativeReview: input.representativeReview || "NOT_REPRESENTATIVE",
    publicReadiness: input.publicReadiness || (status === "REJECTED" ? "INSUFFICIENT" : "INTERNAL_ONLY"),
    publicCandidateReview: input.publicCandidateReview || (status === "REJECTED" ? "REJECT_PUBLIC" : "INTERNAL_ONLY"),
...
module.exports = Object.freeze({
  ...
  MUNICIPALITY_REVIEW_CLASSIFICATIONS, GEOGRAPHY_LINK_REVIEW_CLASSIFICATIONS,
  REPRESENTATIVE_REVIEW_CLASSIFICATIONS, PUBLIC_REVIEW_CLASSIFICATIONS,
