(function (root, factory) {
  ...
  else root.RofoPrivateRecommendationReadiness = factory(root.RofoPrivateLocationComposition, root.RofoSfRetailLocationComposition, root.RofoSfIndustrialFlexLocationComposition, root.RofoSanDiegoIndustrialFlexLocationComposition, root.RofoNorthOrangeCountyIndustrialFlexLocationComposition);
})(typeof self !== "undefined" ? self : this, function (composer, retailComposer, industrialFlexComposer, sanDiegoIndustrialFlexComposer, northOrangeCountyIndustrialFlexComposer) {
  "use strict";
  ...
  function evaluateRecommendationReadiness(requirement, dependencies) {
    ...
    else if (["anaheim", "fullerton"].includes(market) && property === "industrial_flex" && dependencies.northOrangeCountyIndustrialFlexEnabled) result = northOrangeCountyIndustrialFlexUniverse(requirement, dependencies);
    ...
    const northOrangeCountySupported = ["anaheim", "fullerton"].includes(market) && property === "industrial_flex" && dependencies.northOrangeCountyIndustrialFlexEnabled;
    const supportedFoundation = (market === "san-francisco" && ["office", "retail_service", "industrial_flex"].includes(property)) || (market === "san-diego" && property === "industrial_flex" && dependencies.sanDiegoIndustrialFlexEnabled) || northOrangeCountySupported;
    ...
    return {
      ...
      productResponse: (market === "san-diego" && property === "industrial_flex" || northOrangeCountySupported) && readiness !== READINESS.INVESTIGATE
