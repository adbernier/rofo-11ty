(function (root, factory) {
  if (typeof module === "object" && module.exports) module.exports = factory(require("./private-location-composition"));
  else root.RofoPrivateRecommendationReadiness = factory(root.RofoPrivateLocationComposition);
})(typeof self !== "undefined" ? self : this, function (composer) {
  "use strict";
  ...
  function evaluateRecommendationReadiness(requirement, dependencies) {
    ...
    if (property !== "office" || market !== "san-francisco" || (!evaluated.length && blocked.length)) {
    ...
    const composed = readiness === READINESS.INVESTIGATE || !result.composition ? null : composer.composeLocationRecommendations(requirement, dependencies.accessFoundation, dependencies.compositionFoundation, dependencies.sfOfficeModel);
