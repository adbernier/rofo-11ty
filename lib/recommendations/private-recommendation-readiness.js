(function (root, factory) {
...
})(typeof self !== "undefined" ? self : this, function (composer, retailComposer, industrialFlexComposer, sanDiegoIndustrialFlexComposer, northOrangeCountyIndustrialFlexComposer, phoenixIndustrialFlexComposer) {
  "use strict";
  ...
  function evaluateRecommendationReadiness(requirement, dependencies) {
    ...
    const supportedFoundation = (market === "san-francisco" && ["office", "retail_service", "industrial_flex"].includes(property)) || (market === "san-diego" && property === "industrial_flex" && dependencies.sanDiegoIndustrialFlexEnabled) || northOrangeCountySupported || phoenixSupported;
    ...
    return {
      ...
      productResponse: (market === "san-diego" && property === "industrial_flex" || northOrangeCountySupported || phoenixSupported) && readiness !== READINESS.INVESTIGATE
