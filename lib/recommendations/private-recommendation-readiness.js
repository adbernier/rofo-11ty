(function (root, factory) {
  if (typeof module === "object" && module.exports) module.exports = factory(require("./private-location-composition"), require("./sf-retail-location-composition"));
  else root.RofoPrivateRecommendationReadiness = factory(root.RofoPrivateLocationComposition, root.RofoSfRetailLocationComposition);
})(typeof self !== "undefined" ? self : this, function (composer, retailComposer) {
  "use strict";
  ...
  function evaluateRecommendationReadiness(requirement, dependencies) {
    ...
    const supportedFoundation = market === "san-francisco" && ["office", "retail_service"].includes(property);
    if (!supportedFoundation || (!evaluated.length && blocked.length)) {
