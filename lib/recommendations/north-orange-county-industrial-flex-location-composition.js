(function (root, factory) {
  ...
  return { VERSION, desiredTraits: desired, decisiveTraits, resolveMembership: adapter.resolveNorthOrangeCountyIndustrialFlexMembership, composeLocationRecommendations: compose, composeForModel };
});
