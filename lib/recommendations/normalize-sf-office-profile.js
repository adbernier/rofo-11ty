...
function normalizeSfOfficeProfile(sourceAnswers = {}) {
  ...
  addIfPresent(resolverProfile, "commuteOrientation", "commuteOrientation", firstValue(raw.commuteOrientation, raw.constraints && raw.constraints.commuteOrientation), mappings, slugKey);
