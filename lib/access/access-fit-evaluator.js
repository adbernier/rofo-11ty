(function (root, factory) {
  ...
  function cohortResult(cohort, district, foundation) {
    if (cohort.importance === "LOW" || cohort.frequency === "RARE") return { cohortId: cohort.cohortId, actorType: cohort.actorType, originRegionId: cohort.originRegionId, rawOrigin: cohort.rawOrigin || "", importance: cohort.importance, frequency: cohort.frequency, rating: "UNKNOWN", treatment: "CONTEXT_ONLY", modeResults: [], evidenceIds: [] };
    ...
    return {
      cohortId: cohort.cohortId, actorType: cohort.actorType, originRegionId: cohort.originRegionId, rawOrigin: cohort.rawOrigin || "", importance: cohort.importance, frequency: cohort.frequency,
