(function (root, factory) {
  ...
  function createRequirementAccessProfile(requirement = {}, foundation = {}) {
    ...
    const client = clientFrequency(clientVisitItem);
    const cohorts = [
      ...
      ...cohortsFor("CLIENT_CUSTOMER", clientOrigins.resolved, { importance: client.importance, frequency: client.frequency, modePreferences: modes, sourceDimensions: [clientOriginItem && clientOriginItem.dimension, clientVisitItem && clientVisitItem.dimension, transitItem && transitItem.dimension, parkingItem && parkingItem.dimension].filter(Boolean) }),
