...
export const QUESTION_REGISTRY_VERSION = "requirement-questions:v1.6-sf-retail";
export const INTERVIEW_ENGINE_VERSION = "requirement-interview-engine:v1.6-sf-retail";
