...
assert.equal(experiments.experiments.length, 5, "The experiment registry must remain bounded to five hypotheses");
...
console.log("Growth Sprint 1 QA passed: five experiments, public projections, intelligence boundaries, canonical continuity, controlled entry, and observation contracts verified.");
