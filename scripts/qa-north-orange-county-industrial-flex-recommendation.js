...
function requirement(id, activities, summary, cityId = "anaheim", candidates = [], criteria = []) { const city = cityId === "anaheim" ? "Anaheim" : cityId === "fullerton" ? "Fullerton" : cityId; return { id, schemaVersion: "requirement:v1", propertyTypes: ["industrial_flex"], activities, businessContext: { summary }, locationLogic: { marketAnchor: { marketId: "orange-county", geographyId: "orange-county", city, displayName: `${city}, CA` }, specificPreference: { candidateDistrictIds: candidates, candidateDistrictNames: candidates } }, criteria }; }
