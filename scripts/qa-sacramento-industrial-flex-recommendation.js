...
assert(html.includes("Both are worth considering"));
assert(html.includes("Lighter warehouse and service space in north Sacramento") || html.includes("lighter warehouse and service space in north Sacramento"));
assert(html.includes("deeper warehouse, distribution and production district"));
