...
const source=require("./phoenix-commercial-district-intelligence-v1-source");
const root=path.resolve(__dirname,"../.."),out=path.join(root,"data/internal/phoenix-commercial-district-intelligence-v1");
...
write("README.txt","Phoenix Commercial District Intelligence v1\nInternal governed editorial foundation. Public context is not Recommendation Intelligence. City ownership is mandatory; historical availability is excluded.\n");
...
console.log(`Wrote ${Object.values(source.spaceTypes).flat().length} Phoenix district relationships with ${source.totalNewRelationships} bounded additions.`);
