...
if (eastBay) {
  ...
  requireField(lifeScience && lifeScience.counts && lifeScience.counts.representativeBuildings >= 1, `East Bay: life science Representative Building foundation should be credited, got ${lifeScience && lifeScience.counts && lifeScience.counts.representativeBuildings}`);
  requireField(lifeScience && lifeScience.representativeBuildingIntelligence && ["strong", "developed"].includes(lifeScience.representativeBuildingIntelligence.state), `East Bay: life science Representative Building intelligence should be strong or developed after target calibration, got ${lifeScience && lifeScience.representativeBuildingIntelligence && lifeScience.representativeBuildingIntelligence.state}`);
