...
assert(prompt.includes("Tell us what you need"));
...
assert(prompt.includes("Rofo will help you define what you're looking for and create a Location Brief for your search."));
...
assert(mobileEntry.includes('href="{{ mobilePromptHref }}">Tell us what you need</a>'));
assert(businessBriefs.includes("Tell us what you need"));
assert(marketSnapshots.includes('label: "Tell us what you need"'));
