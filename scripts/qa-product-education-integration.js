...
assert(prompt.includes("Get My Recommendation"));
assert(!prompt.includes("Get my recommendations"));
assert(header.includes('href="/find-locations/">Get My Recommendation</a>'));
assert(mobileEntry.includes('href="{{ mobilePromptHref }}">Get My Recommendation</a>'));
assert(businessBriefs.includes("Get My Recommendation"));
