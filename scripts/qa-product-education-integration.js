...
assert(mobileEntry.includes('href="{{ mobilePromptHref }}">Start My Location Brief</a>'));
assert(businessBriefs.includes("Start My Location Brief"));
assert(marketSnapshots.includes('label: "Start My Location Brief"'));
