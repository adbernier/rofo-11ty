...
const source=require("./indianapolis-commercial-district-intelligence-v1-source");
const root=path.resolve(__dirname,"../.."),out=path.join(root,"data/internal/indianapolis-commercial-district-intelligence-v1");
...
console.log(`Wrote ${Object.values(source.spaceTypes).flat().length} Indianapolis district relationships with ${source.totalNewRelationships} bounded additions.`);
