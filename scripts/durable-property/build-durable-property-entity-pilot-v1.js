...
const redirectRows = suppliedRows.map((row) => {
  ...
  const classification=approvedRedirectIds.has(legacyId) ? "GOOD_DIRECT_REDIRECT" : contract.classifyRedirect({
